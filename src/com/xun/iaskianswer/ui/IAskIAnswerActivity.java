    ...
    private void initSpeechListener() {
                    ...
                    new Thread() {
                        ...
                        public void run() {
                            Boolean isVoiceAction = voiceActionManager
                                    .isVoiceAction(getApplicationContext(), rs.get(0));
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                tv.setText(null);
                voiceRequestManager.initVoiceParams(IAskIAnswerActivity.this, mDialog, mRecognitionListener);
    ...
    Handler hanlder = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (mResponse instanceof TextResponse) {
                ...
                Toast.makeText(getApplicationContext(), mUrlResponse.url, Toast.LENGTH_SHORT).show();
                ...
                responseManager.notifyViewPagerDataChanged(mFlightResponse, IAskIAnswerActivity.this, list, textView1,
                ...
                responseManager.notifyViewPagerDataChanged(mMovieResponse, IAskIAnswerActivity.this, list, textView1,
                        textView2, null, null, myPagerAdapter, networkImageView, imageView);
